 ...
 * dependency between two modules that deliberately have none. {@code service} carries the other
 * copy. The databases are named per module for the same reason a container would be — so two suites
